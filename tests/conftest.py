...
# single test or even a module-level `import treeSummary` can run.
#
...
# starts writing into the user's OWN logs. `_logLandmarkProbe` calls
# `_appendPerfLine`, and tests in test_chrome_scope.py and test_walk_wiring.py
...
#
# Pointing APPDATA at an empty temp directory makes `_diagnosticsEnabled()`
